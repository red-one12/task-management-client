  ...
  return (
    <div className="min-h-screen flex justify-center items-center relative">
      ...
      <motion.div
        ...
        className="card bg-white shadow-2xl rounded-lg p-8 max-w-sm w-full"
      >
        <motion.div
          initial={{ scale: 0.95 }}
          animate={{ scale: 1 }}
        ...
        <form onSubmit={handleSignUp}>
          <div className="form-control mb-4">
            ...
            <input
              ...
              className="input input-bordered w-full py-2 px-4 rounded-md border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500 transition duration-300"
              required
            />
          </div>
          <div className="form-control mb-4">
